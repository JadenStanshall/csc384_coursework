...
def test_alternate_fun(): # improved heuristic test, test to see how much better it is
...
def test_iterative_astar_fun():
    ...
    len_benchmark = [-99, 16, 21, 10, 8, -99, -99, 41, 14, -99, 36, 30, 28, 27, 27, -99, -99, -99, -99, -99, 30, 19]
